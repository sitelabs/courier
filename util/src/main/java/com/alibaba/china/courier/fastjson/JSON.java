 ...
 */
package com.alibaba.china.courier.fastjson;
...
import com.alibaba.china.courier.fastjson.serializer.JSONSerializer;
import com.alibaba.china.courier.fastjson.serializer.NameFilter;
import com.alibaba.china.courier.fastjson.serializer.PropertyPreFilter;
import com.alibaba.china.courier.fastjson.serializer.PropertyFilter;
import com.alibaba.china.courier.fastjson.serializer.SerializeConfig;
import com.alibaba.china.courier.fastjson.serializer.SerializeFilter;
import com.alibaba.china.courier.fastjson.serializer.SerializeWriter;
import com.alibaba.china.courier.fastjson.serializer.SerializerFeature;
import com.alibaba.china.courier.fastjson.serializer.ValueFilter;
import com.alibaba.china.courier.fastjson.util.FieldInfo;
import com.alibaba.china.courier.fastjson.util.IOUtils;
import com.alibaba.china.courier.fastjson.util.ThreadLocalCache;
...
public abstract class JSON implements JSONStreamAware, JSONAware {
	...
	static {
		int features = 0;
		features |= com.alibaba.china.courier.fastjson.serializer.SerializerFeature.QuoteFieldNames
				.getMask();
		features |= com.alibaba.china.courier.fastjson.serializer.SerializerFeature.SkipTransientField
				.getMask();
		features |= com.alibaba.china.courier.fastjson.serializer.SerializerFeature.WriteEnumUsingToString
				.getMask();
		features |= com.alibaba.china.courier.fastjson.serializer.SerializerFeature.SortField
				.getMask();
		features |= com.alibaba.china.courier.fastjson.serializer.SerializerFeature.WriteTabAsSpecial
				.getMask();
		// features |=
		// com.alibaba.china.courier.fastjson.serializer.SerializerFeature.WriteSlashAsSpecial.getMask();
	...
	public static final String toJSONString(Object object,
		...
		try {
			...
			for (com.alibaba.china.courier.fastjson.serializer.SerializerFeature feature : features) {

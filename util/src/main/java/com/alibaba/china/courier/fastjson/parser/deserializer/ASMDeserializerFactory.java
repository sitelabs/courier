...
import com.alibaba.china.courier.fastjson.parser.SymbolTable;
import com.alibaba.china.courier.fastjson.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultJSONParser.class), "getContext",
                           "()Lcom/alibaba/china/courier/fastjson/parser/ParseContext;");
            ...
            if (fieldClass == boolean.class) {
                ...
                if (actualTypeArgument instanceof Class) {
                    ...
                    if (itemClass == String.class) {
                        mw.visitLdcInsn(com.alibaba.china.courier.fastjson.asm.Type.getType(getDesc(fieldClass))); // cast
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultJSONParser.class), "clearContext",
                           "(Lcom/alibaba/china/courier/fastjson/parser/ParseContext;I)V");
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.alibaba.china.courier.fastjson.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultJSONParser.class), "getConfig", "()"
                                                                                         + getDesc(ParserConfig.class));
        mw.visitLdcInsn(com.alibaba.china.courier.fastjson.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(ParserConfig.class), "getDeserializer",
                           "(" + getDesc(Type.class) + ")" + getDesc(ObjectDeserializer.class));
